(function(){
'use strict';
if(window.__GABARITO_CLASSROOMS_LOADER_V24__)return;
window.__GABARITO_CLASSROOMS_LOADER_V24__=true;
...
load('/js/classrooms-core-v1.js?v=1.0.1','data-gplus-classrooms-core',()=>{
  ...
  load('/js/teacher-student-profile-v3.js?v=3.0.0','data-gplus-teacher-student-profile-v3');
});
})();