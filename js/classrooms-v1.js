(function(){
'use strict';
if(window.__GABARITO_CLASSROOMS_LOADER_V31__)return;
window.__GABARITO_CLASSROOMS_LOADER_V31__=true;
...
load('/js/classrooms-core-v1.js?v=1.0.1','data-gplus-classrooms-core',()=>{
  ...
  load('/js/coordinator-school-v1.js?v=1.0.1','data-gplus-coordinator-school',()=>{
    load('/js/official-practice-stability-v1.js?v=2.1.0-20260908-unfreeze','data-gplus-official-practice-stability');
  });
});
})();
