(function(){
'use strict';
if(window.__GABARITO_CLASSROOMS_LOADER_V23__)return;
window.__GABARITO_CLASSROOMS_LOADER_V23__=true;
...
load('/js/classrooms-core-v1.js?v=1.0.1','data-gplus-classrooms-core',()=>{
  ...
  load('/js/teacher-student-profile-v1.js?v=1.0.2','data-gplus-teacher-student-profile');
});
})();