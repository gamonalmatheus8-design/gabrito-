...
try{
 ...
 await page.waitForSelector('#v27OfficialRunner .gplus-direct-sync-reader[data-direct-sync-version="3.6.0"]',{timeout:7000});
 ...
 assert.match(await page.locator('#v27OfficialRunner .gplus-direct-sync-reader').innerText(),/GABARITO\+.*SINCRONIZADO/is);
 ...
 await page.waitForFunction(()=>document.querySelector('#v27OfficialRunner .v32-page-label')?.textContent?.includes('Página 2'),{timeout:7000});
