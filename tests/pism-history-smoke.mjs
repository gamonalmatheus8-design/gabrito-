...
try{
 ...
 await page.waitForFunction(()=>window.GABARITO_PISM_DIRECT_SYNC?.version==='3.7.0',{timeout:10000});
 ...
 await page.waitForSelector('#v29PismOfficialRunner .gplus-pism-direct-sync[data-pism-direct-sync-version="3.7.0"]',{timeout:9000});
