...
test('ENEM oficial substitui o simulador legado e carrega sob demanda',()=>{const boot=read('js/gabarito-bootstrap.js'),lazy=read('js/lazy-simulators-v32.js'),official=read('js/enem-official-v27.js');assert.doesNotMatch(boot,/js\/enem-official-v27\.js/);assert.match(lazy,/s\.async=true/);assert.match(lazy,/js\/enem-official-v27\.js/);assert.match(lazy,/js\/enem-history-v28\.js/);assert.match(official,/minutes:330/);assert.match(official,/minutes:300/);assert.match(official,/O ENEM calcula a nota com TRI/)});

test('PISM oficial substitui o simulador legado e carrega sob demanda',()=>{const boot=read('js/gabarito-bootstrap.js'),lazy=read('js/lazy-simulators-v32.js'),official=read('js/pism-history-v29.js');assert.doesNotMatch(boot,/js\/pism-history-v29\.js/);assert.match(lazy,/data\/pism-official-catalog-v29\.js/);assert.match(lazy,/assets\/pism-history-v29\.css/);assert.match(lazy,/js\/pism-history-v29\.js/);assert.match(official,/minutes\|\|240/);assert.match(official,/20 marcadas/);assert.match(official,/fonte oficial UFJF/)});
