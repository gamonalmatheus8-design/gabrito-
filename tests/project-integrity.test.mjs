...
test('versões técnicas estão alinhadas em 2.7.0',()=>{const pkg=JSON.parse(read('package.json'));const boot=read('js/gabarito-bootstrap.js');const sw=read('service-worker.js');assert.equal(pkg.version,'2.7.0');assert.match(boot,/const VERSION='2\.7\.0'/);assert.match(sw,/gabarito-mais-2-7-0-app-shell/);assert.match(sw,/const V='2\.7\.0'/)});
